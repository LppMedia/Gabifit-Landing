        ...
        <div className="md:col-span-4 relative h-80 min-h-[400px] md:min-h-[500px] order-1 md:order-2">
          <AnimatePresence initial={false} custom={direction}>
            <motion.img
              ...
              className="absolute inset-0 w-full h-full object-contain bg-black/10 rounded-lg p-2"
            />
          </AnimatePresence>
        </div>
        ...
        <div className="md:col-span-5 flex flex-col justify-between md:pl-8 order-3 md:order-3">
          ...
          <div className="relative overflow-hidden pt-4 md:pt-24 min-h-[200px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                ...
                <h3 className="text-3xl font-heading mt-2 uppercase">
                  {activeReview.name}
                </h3>
                <blockquote className="mt-6 text-xl md:text-2xl font-medium leading-snug italic font-mono normal-case">
                  "{activeReview.quote}"
                </blockquote>
              </motion.div>
            </AnimatePresence>
          ...
          <div className="flex items-center space-x-2 mt-8 md:mt-0">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-12 h-12 border-muted-foreground/50 border-2"
              onClick={handlePrev}
